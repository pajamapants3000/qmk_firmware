 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Esc  | Grv  | App  | Left | Right|                                       |  Up  | Down |   [  |   ]  |TO-L0 |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  | TO-2 |       | TO-1 | Enter  |
 *                                 ,------|------|------|       |------+--------+------.
...
[SYMB] = KEYMAP(
       ...
       KC_WWW_SEARCH, KC_DLR, KC_KP_1,  KC_KP_2,    KC_KP_3,    KC_KP_ASTERISK, KC_NUMLOCK,
                              KC_KP_0,  KC_KP_DOT,  KC_KP_EQUAL,KC_KP_ENTER,TO(0),
       TO(2), KC_TRNS,
       KC_END,
       KC_TRNS, KC_TRNS, KC_TRNS
),
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | ?Power | ???  | Undo | WlUp | C-Y  | ???  |TRANS |           |TRANS | C-Lft| LClk | MsUp | RClk | C-Rt | Vol-Up |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Reset  |SysRq | WlLt | WlDn | WlRt | ???  |------|           |------| Left | MsLt | MsDn | MsRt | Right| Vol-Dn |
 * |--------+------+------+------+------+------| CALC |           | MAIL |------+------+------+------+------+--------|
 * | Scroll | VERSN| Acc0 | Acc1 | Acc2 | ???  |      |           |      | S-Lft| MB4  | MdClk| MB5  | S-Rt | Mute   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |C-A-6 |C-A-7 |C-A-8 |C-A-9 |C-A-0 |                                       | MUTE | VolUp|VolDn | ???  | TO-L0|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[MDIA] = KEYMAP(
       ...
       KC_POWER, KC_NO, KC_UNDO, KC_MS_WH_UP, RCTL(KC_Y), KC_NO, KC_TRNS,
       RESET, KC_PSCREEN, KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_RIGHT, KC_NO,
       KC_SLCK, M(0), KC_ACL0, KC_ACL1, KC_ACL2, KC_NO, KC_CALCULATOR,
    ...
    // right hand
       ...
       KC_MAIL,  LSFT(KC_LEFT), KC_MS_BTN4, KC_MS_BTN3, KC_MS_BTN5, LSFT(KC_RIGHT), KC_AUDIO_MUTE,
                          KC__MUTE, KC__VOLUP,  KC__VOLDOWN, KC_NO, TO(0),
       TO(0), KC_TRNS,
       KC_TRNS,
